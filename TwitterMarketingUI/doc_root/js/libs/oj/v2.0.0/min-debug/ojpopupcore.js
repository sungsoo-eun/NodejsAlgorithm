...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "jqueryui-amd/position"], function($oj$$28$$, $$$$25$$) {
  ...
  $oj$$28$$.$PositionUtils$.$normalizePositionOf$ = function $$oj$$28$$$$PositionUtils$$$normalizePositionOf$$($of$$, $launcher$$8$$, $event$$374$$) {
    return "event" === $of$$ ? $event$$374$$ : null == $of$$ || "launcher" === $of$$ ? $launcher$$8$$ : $of$$;
  };
  $oj$$28$$.$PositionUtils$.$_normalizeEventForPosition$ = function $$oj$$28$$$$PositionUtils$$$_normalizeEventForPosition$$($event$$375$$) {
    $$$$25$$.each(["pageX", "pageY"], function($index$$190$$, $pagePos$$) {
      if ($event$$375$$ && void 0 === $event$$375$$[$pagePos$$] && $event$$375$$.originalEvent) {
        var $firstTouch$$2_originalEvent$$2$$ = $event$$375$$.originalEvent, $touchList_type$$88$$ = $firstTouch$$2_originalEvent$$2$$.type;
        ($touchList_type$$88$$ = "touchstart" === $touchList_type$$88$$ || "touchmove" === $touchList_type$$88$$ ? "touches" : "touchend" === $touchList_type$$88$$ ? "changedTouches" : null) && ($firstTouch$$2_originalEvent$$2$$ = $firstTouch$$2_originalEvent$$2$$[$touchList_type$$88$$][0]) && ($event$$375$$[$pagePos$$] = $firstTouch$$2_originalEvent$$2$$[$pagePos$$]);
      }
    });
  };
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$triggerOnDescendents$ = function $$oj$$28$$$$PopupServiceImpl$$$$triggerOnDescendents$$($layer$$1_popup$$7$$, $event$$377$$, $argsArray$$1$$) {
    var $context$$107$$ = {};
    $context$$107$$.event = $event$$377$$;
    $context$$107$$.argsArray = $argsArray$$1$$;
    $layer$$1_popup$$7$$ = $oj$$28$$.$ZOrderUtils$.$getFirstAncestorLayer$($layer$$1_popup$$7$$);
    $oj$$28$$.$ZOrderUtils$.$postOrderVisit$($layer$$1_popup$$7$$, this.$_triggerOnDescendentsVisitCallback$, $context$$107$$);
  };
  $oj$$28$$.$PopupServiceImpl$.prototype.$_triggerOnDescendentsVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$$_triggerOnDescendentsVisitCallback$$($layer$$2$$, $context$$108$$) {
    var $event$$378$$ = $context$$108$$.event, $argsArray$$2$$ = $context$$108$$.argsArray, $events$$4$$ = $oj$$28$$.$ZOrderUtils$.$getEvents$($layer$$2$$);
    $events$$4$$ && $$$$25$$.isFunction($events$$4$$[$event$$378$$]) && $events$$4$$[$event$$378$$].apply(this, $argsArray$$2$$);
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$_assertEventSink$ = function $$oj$$28$$$$PopupServiceImpl$$$$_assertEventSink$$() {
    ...
    if (!$docElement_hasPopupsOpen$$ && $callbackEventFilter_simpleTapRecognizer$$) {
      ...
      for (var $i$$327$$ = 0;$i$$327$$ < $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$327$$++) {
        var $event$$379$$ = $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$327$$];
        $docElement_hasPopupsOpen$$.removeEventListener($event$$379$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
      }
      ...
      if ($docElement_hasPopupsOpen$$ && !$callbackEventFilter_simpleTapRecognizer$$) {
        ...
        for ($i$$327$$ = 0;$i$$327$$ < $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$327$$++) {
          $event$$379$$ = $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$327$$], $docElement_hasPopupsOpen$$.addEventListener($event$$379$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
        }
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$_eventFilterCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$$_eventFilterCallback$$($event$$380$$) {
    var $context$$109_target$$89$$ = $$$$25$$($event$$380$$.target);
    if (!$oj$$28$$.$ZOrderUtils$.$hasPopupsOpen$()) {
      this.$_assertEventSink$();
    } else {
      if (!$oj$$28$$.$DomUtils$.$isChromeEvent$($event$$380$$) && ("focus" !== $event$$380$$.type || $context$$109_target$$89$$.is(":focusable"))) {
        var $defaultLayer$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
        if ("keydown" === $event$$380$$.type && $oj$$28$$.$ZOrderUtils$.$hasModalDialogOpen$() && !$oj$$28$$.$DomUtils$.$isAncestor$($defaultLayer$$[0], $context$$109_target$$89$$[0])) {
          $oj$$28$$.$ZOrderUtils$.$eatEvent$($$$$25$$.Event($event$$380$$));
        } else {
          var $props$$16_targetWitinLayer$$ = $oj$$28$$.$ZOrderUtils$.$getFirstAncestorLayer$($context$$109_target$$89$$);
          ...
          if ("focus" !== $event$$380$$.type || "-1" !== $context$$109_target$$89$$.attr("tabindex")) {
            var $context$$109_target$$89$$ = {}, $props$$16_targetWitinLayer$$ = {}, $key$$139$$;
            for ($key$$139$$ in $event$$380$$) {
              $oj$$28$$.$PopupServiceImpl$.$_COPY_SAFE_EVENT_PROPERTIES$[$key$$139$$] && !$$$$25$$.isFunction($event$$380$$[$key$$139$$]) && ($props$$16_targetWitinLayer$$[$key$$139$$] = $event$$380$$[$key$$139$$]);
            }
            $context$$109_target$$89$$.event = $$$$25$$.Event($event$$380$$, $props$$16_targetWitinLayer$$);
            $oj$$28$$.$ZOrderUtils$.$postOrderVisit$($defaultLayer$$, $oj$$28$$.$PopupServiceImpl$.$_redistributeVisitCallback$, $context$$109_target$$89$$);
          }
        }
      }
    }
  };
  $oj$$28$$.$PopupServiceImpl$.$_redistributeVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$_redistributeVisitCallback$$($layer$$3$$, $context$$110$$) {
    var $events$$5$$ = $oj$$28$$.$ZOrderUtils$.$getEvents$($layer$$3$$), $event$$381$$ = $context$$110$$.event;
    if ($events$$5$$ && $$$$25$$.isFunction($events$$5$$[$oj$$28$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$])) {
      $events$$5$$[$oj$$28$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$]($event$$381$$);
    }
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  ...
  $oj$$28$$.$PopupServiceImpl$.$_refreshVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$_refreshVisitCallback$$($layer$$4$$, $context$$111$$) {
    if (0 < $context$$111$$.level) {
  ...
  $oj$$28$$.$ZOrderUtils$.$_closeDescendantPopupsCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_closeDescendantPopupsCallback$$($layer$$11$$, $context$$112$$) {
    if (0 < $context$$112$$.level) {
      return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$REJECT$;
    }
  ...
  $oj$$28$$.$ZOrderUtils$.$postOrderVisit$ = function $$oj$$28$$$$ZOrderUtils$$$postOrderVisit$$($layer$$15$$, $callback$$102$$, $context$$113$$) {
    $context$$113$$ || ($context$$113$$ = {});
    $context$$113$$.level = 0;
    $context$$113$$.type = $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$;
    $oj$$28$$.$ZOrderUtils$.$_visitTree$($layer$$15$$, $callback$$102$$, $context$$113$$);
  };
  $oj$$28$$.$ZOrderUtils$.$preOrderVisit$ = function $$oj$$28$$$$ZOrderUtils$$$preOrderVisit$$($layer$$16$$, $callback$$103$$, $context$$114$$) {
    $context$$114$$ || ($context$$114$$ = {});
    $context$$114$$.level = 0;
    $context$$114$$.type = $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$;
    $oj$$28$$.$ZOrderUtils$.$_visitTree$($layer$$16$$, $callback$$103$$, $context$$114$$);
  };
  $oj$$28$$.$ZOrderUtils$.$_visitTree$ = function $$oj$$28$$$$ZOrderUtils$$$_visitTree$$($children$$9_layer$$17$$, $callback$$104$$, $context$$115$$) {
    var $level$$28$$ = $context$$115$$.level;
    ...
    for (var $i$$329$$ = $children$$9_layer$$17$$.length - 1;-1 < $i$$329$$;$i$$329$$--) {
      ...
      if ($oj$$28$$.$ZOrderUtils$.$_hasSurrogate$($child$$8$$[0])) {
        var $vrtn$$;
        if ($context$$115$$.type === $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$) {
          $vrtn$$ = $callback$$104$$($child$$8$$, $context$$115$$);
        ...
        $context$$115$$.level = $level$$28$$ + 1;
        $vrtn$$ = $oj$$28$$.$ZOrderUtils$.$_visitTree$($child$$8$$, $callback$$104$$, $context$$115$$);
        $context$$115$$.level = $level$$28$$;
        if ($vrtn$$ === $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
          return $vrtn$$;
        }
        if ($context$$115$$.type === $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$) {
          $vrtn$$ = $callback$$104$$($child$$8$$, $context$$115$$);
          if ($vrtn$$ === $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
            return $vrtn$$;
          }
  ...
  $oj$$28$$.$ZOrderUtils$.$getOpenPopupCount$ = function $$oj$$28$$$$ZOrderUtils$$$getOpenPopupCount$$() {
    var $context$$116$$ = {popupCount:0}, $defaultLayer$$5$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$28$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$5$$, $oj$$28$$.$ZOrderUtils$.$_openPopupCountCallback$, $context$$116$$);
    return $context$$116$$.popupCount;
  };
  $oj$$28$$.$ZOrderUtils$.$_openPopupCountCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_openPopupCountCallback$$($layer$$18$$, $context$$117$$) {
    $context$$117$$.popupCount += 1;
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$28$$.$ZOrderUtils$.$findOpenPopups$ = function $$oj$$28$$$$ZOrderUtils$$$findOpenPopups$$() {
    var $context$$118$$ = {}, $defaultLayer$$6_popups$$2$$ = [];
    $context$$118$$.popups = $defaultLayer$$6_popups$$2$$;
    $defaultLayer$$6_popups$$2$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$28$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$6_popups$$2$$, $oj$$28$$.$ZOrderUtils$.$_openPopupsCallback$, $context$$118$$);
    $defaultLayer$$6_popups$$2$$ = $context$$118$$.popups;
    return $$$$25$$($defaultLayer$$6_popups$$2$$);
  };
  $oj$$28$$.$ZOrderUtils$.$_openPopupsCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_openPopupsCallback$$($layer$$19$$, $context$$119$$) {
    $context$$119$$.popups.push($layer$$19$$[0]);
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$28$$.$ZOrderUtils$.$compareStackingContexts$ = function $$oj$$28$$$$ZOrderUtils$$$compareStackingContexts$$($el1$$1$$, $el2$$1$$) {
    function $describeStackingContext$$($element$$120$$, $allLevels$$) {
      ...
      for (var $stack_tmp$$2$$ = [], $level$$29$$ = 0, $i$$331$$ = 0;$i$$331$$ < $parents$$4$$.length;$i$$331$$++) {
        var $order_parent$$33$$ = $parents$$4$$[$i$$331$$], $position$$21$$ = $order_parent$$33$$.css("position"), $opacity$$1$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsFloat$($order_parent$$33$$.css("opacity")), $zindex$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsInt$($order_parent$$33$$.css("z-index")), $order_parent$$33$$ = $$$$25$$.inArray($order_parent$$33$$[0], $order_parent$$33$$.parent().children());
  ...
  $oj$$28$$.$ZOrderUtils$.$eatEvent$ = function $$oj$$28$$$$ZOrderUtils$$$eatEvent$$($event$$383$$) {
    $event$$383$$.stopPropagation();
    $event$$383$$.preventDefault();
  };
  ...
  $oj$$28$$.$SimpleTapRecognizer$.prototype.$_eventHandler$ = function $$oj$$28$$$$SimpleTapRecognizer$$$$_eventHandler$$($event$$384_tapStart$$) {
    var $tapCallback$$1$$ = this.$_tapCallback$, $eventType$$42$$ = $event$$384_tapStart$$.type;
    "touchstart" === $eventType$$42$$ ? (this.$_touchStartEvent$ = $event$$384_tapStart$$, this.$_touchStartEvent$.$_tapStart$ = (new Date).getTime()) : "touchmove" === $eventType$$42$$ || "touchcancel" === $eventType$$42$$ ? delete this.$_touchStartEvent$ : "touchend" === $eventType$$42$$ && (this.$_touchStartEvent$ && ($event$$384_tapStart$$ = this.$_touchStartEvent$.$_tapStart$, isNaN($event$$384_tapStart$$) ? $tapCallback$$1$$(this.$_touchStartEvent$) : (new Date).getTime() - $event$$384_tapStart$$ <
  ...
  $oj$$28$$.$PopupSkipLink$ = function $$oj$$28$$$$PopupSkipLink$$($sibling$$, $message$$35$$, $callback$$105$$, $id$$42$$) {
    $oj$$28$$.$Assert$.$assertPrototype$($sibling$$, jQuery);
    $oj$$28$$.$Assert$.$assertString$($message$$35$$);
    $oj$$28$$.$Assert$.$assertFunction$($callback$$105$$);
