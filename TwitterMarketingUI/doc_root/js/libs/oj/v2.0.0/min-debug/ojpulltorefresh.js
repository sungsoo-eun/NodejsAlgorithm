...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$31$$, $$$$28$$) {
  ...
  $oj$$31$$.$PullToRefreshUtils$.$setupPullToRefresh$ = function $$oj$$31$$$$PullToRefreshUtils$$$setupPullToRefresh$$($element$$121$$, $refreshFunc$$, $options$$300$$) {
    ...
    $panel$$.prepend($outer$$);
    $panel$$.on("touchstart.pulltorefresh", function($event$$386$$) {
      null == $$$$28$$.data($content$$23$$[0], "data-pullstart") && 0 === $panel$$[0].scrollTop && ($oj$$31$$.$PullToRefreshUtils$.$_handlePull$($event$$386$$, $content$$23$$, $options$$300$$), $icon$$7$$ = $content$$23$$.find(".oj-pulltorefresh-icon"), 0 < $icon$$7$$.length && ($iconOffset$$ = $icon$$7$$.parent().outerHeight(!0)), $options$$300$$ && !isNaN($options$$300$$.threshold) && ($threshold$$1$$ = parseInt($options$$300$$.threshold, 10)), $threshold$$1$$ = isNaN($threshold$$1$$) ? $content$$23$$.outerHeight(!0) :
      Math.max(0, Math.min($threshold$$1$$, $content$$23$$.outerHeight(!0))), $content$$23$$.css("height", 0), $content$$23$$.removeClass("oj-pulltorefresh-transition"), $$$$28$$.data($content$$23$$[0], "data-pullstart", $event$$386$$.originalEvent.touches[0].clientY));
    }).on("touchmove.pulltorefresh", function($event$$387$$) {
      $start$$45$$ = $$$$28$$.data($content$$23$$[0], "data-pullstart");
      null != $start$$45$$ && ($height$$25$$ = $event$$387$$.originalEvent.touches[0].clientY - parseInt($start$$45$$, 10), 0 > $height$$25$$ || ($event$$387$$.preventDefault(), null != $$$$28$$.data($content$$23$$[0], "data-loading") ? $content$$23$$.css("height", Math.max($height$$25$$, $threshold$$1$$)) : ($content$$23$$.css("height", $height$$25$$), $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$387$$, "pull", $content$$23$$, $height$$25$$), null != $icon$$7$$ && 0 < $icon$$7$$.length &&
    ...
    }).on("touchend.pulltorefresh", function($event$$389$$) {
      $start$$45$$ = $$$$28$$.data($content$$23$$[0], "data-pullstart");
      null != $start$$45$$ && null == $$$$28$$.data($content$$23$$[0], "data-loading") && ($content$$23$$.outerHeight() < $threshold$$1$$ ? ($content$$23$$.addClass("oj-pulltorefresh-transition").css("height", 0), $oj$$31$$.$PullToRefreshUtils$.$_cleanup$($content$$23$$)) : $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$($event$$389$$, $content$$23$$, $refreshFunc$$));
    });
  };
  $goog$exportPath_$$("PullToRefreshUtils.setupPullToRefresh", $oj$$31$$.$PullToRefreshUtils$.$setupPullToRefresh$, $oj$$31$$);
  $oj$$31$$.$PullToRefreshUtils$.$_handlePull$ = function $$oj$$31$$$$PullToRefreshUtils$$$_handlePull$$($event$$390$$, $content$$24$$, $options$$301$$) {
    var $primaryText$$, $secondaryText$$;
    $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$390$$, "pull", $content$$24$$, 0);
  ...
  $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$ = function $$oj$$31$$$$PullToRefreshUtils$$$_handleRelease$$($event$$391$$, $content$$25$$, $refreshFunc$$1$$) {
    ...
    $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$391$$, "release", $content$$25$$, $height$$26$$);
    ...
    $refreshFunc$$1$$().then(function() {
      $listener$$37$$ = function $$listener$$37$$$() {
        $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$391$$, "complete", $content$$25$$, $height$$26$$);
  ...
  $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$ = function $$oj$$31$$$$PullToRefreshUtils$$$_fireEvent$$($originalEvent$$3$$, $event$$392_key$$140$$, $content$$26$$, $distance$$) {
    $event$$392_key$$140$$ = $$$$28$$.Event("oj" + $event$$392_key$$140$$);
    $event$$392_key$$140$$.originalEvent = $originalEvent$$3$$;
    $content$$26$$.trigger($event$$392_key$$140$$, {content:$content$$26$$, distance:$distance$$});
  };
  ...
  $oj$$31$$.$PullToRefreshUtils$.$_renderAccessibleLink$ = function $$oj$$31$$$$PullToRefreshUtils$$$_renderAccessibleLink$$($panel$$1$$, $refreshFunc$$2$$, $options$$302$$) {
    ...
    }).blur(function($event$$393$$) {
      null != $event$$393$$.relatedTarget && $link$$4$$.css("position", "");
    }).click(function($event$$394$$) {
      $content$$29$$ = $panel$$1$$.children().last();
      $oj$$31$$.$PullToRefreshUtils$.$_handlePull$($event$$394$$, $content$$29$$, $options$$302$$);
      $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$($event$$394$$, $content$$29$$, $refreshFunc$$2$$);
      $refreshFunc$$2$$();
    });
