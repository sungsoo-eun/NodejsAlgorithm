...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore"], function($oj$$79$$, $$$$73$$) {
  (function() {
    $oj$$79$$.$__registerWidget$("oj.ojMenu", $$$$73$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", delay:300, role:"menu", widgetEventPrefix:"oj", options:{menuSelector:"ul", openOptions:{initialFocus:"menu", launcher:null, position:{my:"start top", at:"start bottom", collision:"flipfit"}}, submenuOpenOptions:{position:{my:"start top", at:"end top", collision:"flipfit"}}, beforeOpen:null, close:null, open:null, select:null}, _ComponentCreate:function() {
      ...
      var $handleMouseEnterMenuItem$$ = function($event$$655$$) {
        if (!this.$focusHandled$) {
          this.$focusHandled$ = !0;
          var $target$$102$$ = $$$$73$$($event$$655$$.currentTarget);
          $target$$102$$.siblings().removeClass("oj-focus-ancestor");
          this.$_focus$($event$$655$$, $target$$102$$);
        }
      }.bind(this);
      this._on({"mousedown .oj-menu-item \x3e a":function($event$$656$$) {
        ...
        var $target$$103$$ = $$$$73$$($event$$661$$.target).closest(".oj-menu-item");
        !this.$mouseHandled$ && $target$$103$$.not(".oj-disabled").length && (this.$mouseHandled$ = !0, $event$$661$$.preventDefault(), this.$active$ && this.$active$.closest($target$$103$$).length && this.$active$.get(0) != $target$$103$$.get(0) || ($target$$103$$.has(".oj-menu").length ? this.$_expand$($event$$661$$) : (this.$_select$($event$$661$$), this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.$active$ && 1 === this.$active$.parents(".oj-menu").length && clearTimeout(this.$timer$)))));
    ...
    }, _setOption:function($key$$192$$, $value$$301$$) {
      this._superApply(arguments);
      this.$_launcher$ || ("submenuOpenOptions" === $key$$192$$ ? this.$_submenuPosition$ = $oj$$79$$.$PositionUtils$.$normalizeHorizontalAlignment$($value$$301$$.position, this.$isRtl$) : "submenuOpenOptions.position" === $key$$192$$ && (this.$_submenuPosition$ = $oj$$79$$.$PositionUtils$.$normalizeHorizontalAlignment$($value$$301$$, this.$isRtl$)));
    }, _destroy:function() {
      ...
      $oj$$79$$.$PositionUtils$.$_normalizeEventForPosition$($event$$675$$);
      ...
      if ($beforeOpenResults_position$$51$$.proceed) {
        ...
        if (this.element.is(":visible") && (this.$_currentOpenOptions$ = $launcher$$25_oldOpenOptions$$, this.$__dismiss$($beforeOpenResults_position$$51$$.event), this.$_currentOpenOptions$ = $initialFocus$$2_openOptions$$7$$), $launcher$$25_oldOpenOptions$$ = $initialFocus$$2_openOptions$$7$$.launcher, ($launcher$$25_oldOpenOptions$$ = "string" === $$$$73$$.type($launcher$$25_oldOpenOptions$$) ? $$$$73$$($launcher$$25_oldOpenOptions$$) : $launcher$$25_oldOpenOptions$$) && $launcher$$25_oldOpenOptions$$.length) {
          if ($beforeOpenResults_position$$51$$ = $oj$$79$$.$PositionUtils$.$normalizeHorizontalAlignment$($initialFocus$$2_openOptions$$7$$.position, this.$isRtl$), $beforeOpenResults_position$$51$$.of = $oj$$79$$.$PositionUtils$.$normalizePositionOf$($beforeOpenResults_position$$51$$.of, $launcher$$25_oldOpenOptions$$, $event$$675$$), null == $beforeOpenResults_position$$51$$.of) {
            $oj$$79$$.$Logger$.warn("position.of passed to Menu.open() is 'event', but the event is null.  Ignoring the call."), this.$_currentOpenOptions$ = null;
          } else {
            ...
            this.$_submenuPosition$ = $oj$$79$$.$PositionUtils$.$normalizeHorizontalAlignment$($focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$.position, this.$isRtl$);
            ...
            $focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$POPUP$] = this.element;
            $focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$LAUNCHER$] = $launcher$$25_oldOpenOptions$$;
            $focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$POSITION$] = $beforeOpenResults_position$$51$$;
            $focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$EVENTS$] = this.$_getPopupServiceEvents$();
            $focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$[$oj$$79$$.$PopupService$.$OPTION$.$LAYER_SELECTORS$] = "oj-menu-layer";
            $oj$$79$$.$PopupService$.$getInstance$().open($focusFirstItem_psOptions$$9_submenuOpenOptions$$1_usingCallback$$1$$);
          ...
          $oj$$79$$.$Logger$.warn("When calling Menu.open(), must specify openOptions.launcher via the component option, method param, or beforeOpen listener.  Ignoring the call."), this.$_currentOpenOptions$ = null;
        }
      }
      ...
      if (null == $which$$ || "active" === $which$$) {
        ...
        "all" === $which$$ || "eventSubtree" === $which$$ ? this.$__collapseAll$($event$$677$$, "all" === $which$$, this.delay) : $oj$$79$$.$Logger$.warn("Invalid param " + $which$$ + " passed to Menu._collapse().  Ignoring the call.");
      }
      ...
      this.$active$ ? this.$active$.has(".oj-menu").length || this.$active$.is(".oj-disabled") ? $oj$$79$$.$Logger$.warn("Selecting a disabled menu item or parent menu item is not allowed.") : ($menuItem$$3_ui$$48$$ = {item:this.$active$}, this.$__collapseAll$($event$$682$$, !0), this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$682$$, $menuItem$$3_ui$$48$$)) : $oj$$79$$.$Logger$.warn("Menu._select() called when no menu item is focused and no menu item can be inferred from event param.");
