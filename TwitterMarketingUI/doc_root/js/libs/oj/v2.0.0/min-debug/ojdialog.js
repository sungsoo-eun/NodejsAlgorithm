...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore", "jqueryui-amd/draggable", "jqueryui-amd/mouse"], function($oj$$38$$, $$$$35$$) {
  (function() {
    $oj$$38$$.$__registerWidget$("oj.ojResizable", $$$$35$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, resize:null, start:null, stop:null}, $_num$:function($value$$259$$) {
      ...
      this._super();
      var $n$$24_o$$, $i$$342_mouseConstructor$$, $handle$$19$$, $axis$$27$$, $hname$$, $that$$1$$ = this;
      $n$$24_o$$ = this.options;
      ...
      if (this.handles.constructor === String) {
        for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), $n$$24_o$$ = this.handles.split(","), this.handles = {}, $i$$342_mouseConstructor$$ = 0;$i$$342_mouseConstructor$$ < $n$$24_o$$.length;$i$$342_mouseConstructor$$++) {
          $handle$$19$$ = $$$$35$$.trim($n$$24_o$$[$i$$342_mouseConstructor$$]), $hname$$ = "oj-resizable-" + $handle$$19$$, $axis$$27$$ = $$$$35$$("\x3cdiv class\x3d'oj-resizable-handle " + $hname$$ + "'\x3e\x3c/div\x3e"), this.handles[$handle$$19$$] = ".oj-resizable-" + $handle$$19$$, this.element.append($axis$$27$$);
        }
      }
      ...
      for ($i$$344$$ in this.handles) {
        if ($handle$$20$$ = $$$$35$$(this.handles[$i$$344$$])[0], $handle$$20$$ === $event$$431$$.target || $$$$35$$.contains($handle$$20$$, $event$$431$$.target)) {
          $capture$$ = !0;
        }
      }
      ...
      function $_alsoResize$$($exp$$4$$, $c$$46$$) {
        $$$$35$$($exp$$4$$).each(function() {
          ...
          $$$$35$$.each($c$$46$$ && $c$$46$$.length ? $c$$46$$ : $el$$15$$.parents($ui$$22$$.$originalElement$[0]).length ? ["width", "height"] : ["width", "height", "top", "left"], function($i$$346$$, $prop$$66$$) {
  ...
  (function() {
    $oj$$38$$.$__registerWidget$("oj.ojDialog", $$$$35$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancelBehavior:"icon", dragAffordance:"title-bar", initialVisibility:"hide", modality:"modal", position:{my:"center", at:"center", of:window, collision:"fit", $using$:function($pos$$9$$) {
    ...
    }, _keepFocus:function($activeElement$$inline_890_event$$448$$) {
      $activeElement$$inline_890_event$$448$$.preventDefault();
      $activeElement$$inline_890_event$$448$$ = this.document[0].activeElement;
      this.$uiDialog$[0] === $activeElement$$inline_890_event$$448$$ || $$$$35$$.contains(this.$uiDialog$[0], $activeElement$$inline_890_event$$448$$) || this.$_focusTabbable$();
    ...
    }, _setOption:function($isDraggable$$1_key$$146$$, $value$$262$$, $flags$$37$$) {
      var $isResizable_psOptions$$4_uiDialog$$;
      $isResizable_psOptions$$4_uiDialog$$ = this.$uiDialog$;
      if ("disabled" !== $isDraggable$$1_key$$146$$) {
        switch(this._super($isDraggable$$1_key$$146$$, $value$$262$$, $flags$$37$$), $isDraggable$$1_key$$146$$) {
          case "dragAffordance":
            ($isDraggable$$1_key$$146$$ = $isResizable_psOptions$$4_uiDialog$$.hasClass("oj-draggable")) && "none" === $value$$262$$ && ($isResizable_psOptions$$4_uiDialog$$.draggable("destroy"), this.$uiDialog$.removeClass("oj-draggable"));
            $isDraggable$$1_key$$146$$ || "title-bar" !== $value$$262$$ || this.$_makeDraggable$();
            break;
          case "position":
            this.$_position$();
            break;
      ...
      return null;
    }, getSubIdByNode:function($node$$93_nodeCached$$3$$) {
      if (null != $node$$93_nodeCached$$3$$) {
        $node$$93_nodeCached$$3$$ = $$$$35$$($node$$93_nodeCached$$3$$);
        if ($node$$93_nodeCached$$3$$.hasClass("oj-dialog-header")) {
          return{subId:"oj-dialog-header"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-dialog-footer")) {
          return{subId:"oj-dialog-footer"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-dialog-content")) {
          return{subId:"oj-dialog-content"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-dialog-header-close-wrapper")) {
          return{subId:"oj-dialog-header-close-wrapper"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-dialog-close-icon")) {
          return{subId:"oj-dialog-close"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-n")) {
          return{subId:"oj-resizable-n"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-e")) {
          return{subId:"oj-resizable-e"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-s")) {
          return{subId:"oj-resizable-s"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-w")) {
          return{subId:"oj-resizable-w"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-se")) {
          return{subId:"oj-resizable-se"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-sw")) {
          return{subId:"oj-resizable-sw"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-ne")) {
          return{subId:"oj-resizable-ne"};
        }
        if ($node$$93_nodeCached$$3$$.hasClass("oj-resizable-nw")) {
