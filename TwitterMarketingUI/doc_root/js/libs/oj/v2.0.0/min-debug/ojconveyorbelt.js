...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$77$$, $$$$71$$) {
  ...
  $ConveyorBeltCommon$$.$_addBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_addBubbleEventListener$$($node$$170$$, $type$$107$$, $listener$$42$$) {
    $node$$170$$.addEventListener ? $node$$170$$.addEventListener($type$$107$$, $listener$$42$$, !1) : $node$$170$$.attachEvent && $node$$170$$.attachEvent("on" + $type$$107$$, $listener$$42$$);
  };
  $ConveyorBeltCommon$$.$_removeBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_removeBubbleEventListener$$($node$$171$$, $type$$108$$, $listener$$43$$) {
    $node$$171$$.removeEventListener ? $node$$171$$.removeEventListener($type$$108$$, $listener$$43$$, !1) : $node$$171$$.detachEvent && $node$$171$$.detachEvent("on" + $type$$108$$, $listener$$43$$);
  };
  ...
  (function() {
    $oj$$77$$.$__registerWidget$("oj.ojConveyorBelt", $$$$71$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      ...
      this._super();
    }, _setOption:function($key$$191$$, $value$$298$$, $flags$$55$$) {
      var $bRecreate$$2$$ = !1;
      switch($key$$191$$) {
      ...
      this._super($key$$191$$, $value$$298$$, $flags$$55$$);
      ...
      $element$$144$$.on("mousedown" + this.eventNamespace, function($event$$648$$) {
