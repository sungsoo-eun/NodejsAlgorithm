...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$42$$) {
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.getData = function $$oj$$42$$$$CollectionHeaderSet$$$getData$($index$$202$$, $level$$30$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $model$$67$$ = this.$m_models$[$index$$202$$ - this.$m_start$];
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.getMetadata = function $$oj$$42$$$$CollectionHeaderSet$$$getMetadata$($index$$203$$, $level$$31$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $data$$153_model$$68$$ = this.$m_models$[$index$$203$$ - this.$m_start$];
      return{key:$oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($data$$153_model$$68$$)};
    }
    $data$$153_model$$68$$ = this.getData($index$$203$$, $level$$31$$);
  ...
  $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$ = function $$oj$$42$$$$CollectionDataGridUtils$$$_getModelKey$$($model$$71$$) {
    var $key$$147$$;
    $key$$147$$ = $model$$71$$.$GetId$();
    null == $key$$147$$ && ($key$$147$$ = $model$$71$$.$GetCid$());
    return $key$$147$$;
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$fetchHeaders$$($headerRange$$1$$, $callbacks$$18$$, $callbackObjects$$4$$) {
    var $axis$$32$$, $callback$$113$$;
    null != $callbacks$$18$$ && ($axis$$32$$ = $headerRange$$1$$.axis, $callback$$113$$ = {}, $callback$$113$$.$headerRange$ = $headerRange$$1$$, $callback$$113$$.callbacks = $callbacks$$18$$, $callback$$113$$.$callbackObjects$ = $callbackObjects$$4$$, this.$pendingHeaderCallback$[$axis$$32$$] = $callback$$113$$);
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.keys = function $$oj$$42$$$$CollectionDataGridDataSource$$$keys$($indexes$$11$$) {
    ...
    return new Promise(function($resolve$$43$$) {
      $self$$160$$.$collection$.at($rowIndex$$6$$, {deferred:!0}).then(function($rowModel$$) {
        null == $rowModel$$ ? $resolve$$43$$({row:null, column:null}) : ($rowKey$$30$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($rowModel$$), null == $self$$160$$.columns && $self$$160$$.$_setupColumns$($rowModel$$), $columnKey$$1$$ = $self$$160$$.columns[$columnIndex$$2$$], $resolve$$43$$({row:$rowKey$$30$$, column:$columnKey$$1$$}));
      }.bind($self$$160$$));
    });
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$37$$) {
    ...
    return new Promise(function($resolve$$44$$) {
      $self$$161$$.$collection$.indexOf($rowKey$$31$$, {deferred:!0}).then(function($rowIndex$$7$$) {
        -1 === $rowIndex$$7$$ ? $resolve$$44$$({row:-1, column:-1}) : null == $self$$161$$.columns ? $self$$161$$.$collection$.at($rowIndex$$7$$, {deferred:!0}).then(function($model$$74$$) {
          $self$$161$$.$_setupColumns$($model$$74$$);
          $columnIndex$$3$$ = $self$$161$$.columns.indexOf($columnKey$$2$$);
          -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1);
          $resolve$$44$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$});
        }.bind($self$$161$$)) : ($columnIndex$$3$$ = $self$$161$$.columns.indexOf($columnKey$$2$$), -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1), $resolve$$44$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$}));
      }.bind($self$$161$$));
    });
  };
