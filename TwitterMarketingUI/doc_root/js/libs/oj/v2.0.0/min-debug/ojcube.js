...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatasource-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$ProcessLevel$$($axis$$15$$, $levelNum$$1$$, $currNode$$1_node$$64$$, $row$$26$$, $keys$$19$$, $addKeys$$1$$) {
    if ($levelNum$$1$$ >= $axis$$15$$.$getLevels$().length) {
      return $keys$$19$$;
    }
    var $level$$18$$ = $axis$$15$$.$getLevels$()[$levelNum$$1$$];
    if ($level$$18$$.$isDataValue$()) {
      return this.$_processDataValue$($axis$$15$$, $currNode$$1_node$$64$$, $row$$26$$, $levelNum$$1$$, $keys$$19$$);
    }
    $currNode$$1_node$$64$$ = $currNode$$1_node$$64$$.$AddNode$($row$$26$$[$level$$18$$.attribute], null, $level$$18$$);
    $addKeys$$1$$ && $keys$$19$$.$UpdateKeys$($currNode$$1_node$$64$$);
    return this.$ProcessLevel$($axis$$15$$, $levelNum$$1$$ + 1, $currNode$$1_node$$64$$, $row$$26$$, $keys$$19$$, $addKeys$$1$$);
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_processDataValue$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_processDataValue$$($axis$$16$$, $node$$65$$, $row$$27$$, $levelNum$$2$$, $keys$$20$$) {
    for (var $dsKeysAdded$$ = !0, $d$$6$$ = 0;$d$$6$$ < this.$_dataValues$.length;$d$$6$$++) {
      ...
      $row$$27$$.hasOwnProperty($dvAttr$$) && ($currNode$$2_dvLabel$$ = $node$$65$$.$AddNode$($dvAttr$$, $currNode$$2_dvLabel$$, $axis$$16$$.$getLevels$()[$levelNum$$2$$]), $keys$$20$$.$AddDataValue$($dvAttr$$, $row$$27$$[$dvAttr$$]), this.$ProcessLevel$($axis$$16$$, $levelNum$$2$$ + 1, $currNode$$2_dvLabel$$, $row$$27$$, $keys$$20$$, $dsKeysAdded$$), $dsKeysAdded$$ = !1);
    }
    return $keys$$20$$;
  };
  ...
  $oj$$18$$.$CubeKeys$.prototype.$UpdateKeys$ = function $$oj$$18$$$$CubeKeys$$$$UpdateKeys$$($node$$66$$) {
    this.$_key$.push($node$$66$$);
  };
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getMetadata = function $$oj$$18$$$$CubeHeaderSet$$$getMetadata$($index$$120$$, $level$$20$$) {
    var $hash$$6_keys$$21$$ = new $oj$$18$$.$CubeKeys$, $hash$$6_keys$$21$$ = this.$_axis$.$GetPartialCubeKeys$($index$$120$$, $level$$20$$, $hash$$6_keys$$21$$);
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getKey$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getKey$$($indexes$$5_item$$14$$, $axis$$20$$, $retObj$$14$$) {
    ...
    $retObj$$14$$[$axis$$20$$] = $keys$$22$$.$GetHashCodes$()[0].key;
    return $retObj$$14$$;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getIndex$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getIndex$$($keys$$24$$, $axis$$21$$, $retObj$$16$$) {
    $retObj$$16$$[$axis$$21$$] = this.$_getAxis$($axis$$21$$).$getIndex$($keys$$24$$[$axis$$21$$]);
    return $retObj$$16$$;
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataColumnCube$$$$ProcessLevel$$($axis$$25$$, $levelNum$$3$$, $currNode$$3_node$$67$$, $row$$28$$, $keys$$25$$, $addKeys$$2$$) {
    if ($levelNum$$3$$ >= $axis$$25$$.$getLevels$().length) {
      return $keys$$25$$;
    }
    var $level$$25$$ = $axis$$25$$.$getLevels$()[$levelNum$$3$$], $value$$237$$ = $row$$28$$[$level$$25$$.attribute];
    $currNode$$3_node$$67$$ = $currNode$$3_node$$67$$.$AddNode$($value$$237$$, null, $level$$25$$);
    $level$$25$$.$isDataValue$() ? $keys$$25$$.$AddDataValue$($value$$237$$, $row$$28$$[this.$_valueAttr$]) : $keys$$25$$.$UpdateKeys$($currNode$$3_node$$67$$);
    return this.$ProcessLevel$($axis$$25$$, $levelNum$$3$$ + 1, $currNode$$3_node$$67$$, $row$$28$$, $keys$$25$$, $addKeys$$2$$);
  };
