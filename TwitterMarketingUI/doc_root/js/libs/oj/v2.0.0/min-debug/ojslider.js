...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$45$$, $$$$41$$) {
  (function() {
    $oj$$45$$.$__registerWidget$("oj.ojSlider", $$$$41$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.0.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0, rawValue:void 0}, $_numPages$:5, $_sliderDisplayValue$:null, $_isRTL$:function() {
    ...
    }, _setOption:function($key$$151$$, $coercedValue_value$$266$$, $flags$$39$$) {
      "value" === $key$$151$$ && (Array.isArray($coercedValue_value$$266$$) ? isNaN($coercedValue_value$$266$$[0]) ? (this.$_multipleThumbs$ = !1, this.$_parse$($key$$151$$, $coercedValue_value$$266$$[0])) : this.$_multipleThumbs$ = !0 : (this.$_multipleThumbs$ = !1, this.$_parse$($key$$151$$, $coercedValue_value$$266$$)));
      $coercedValue_value$$266$$ = "max" === $key$$151$$ || "min" === $key$$151$$ ? this.$_parse$($key$$151$$, $coercedValue_value$$266$$) : "step" === $key$$151$$ ? this.$_parseStep$($coercedValue_value$$266$$) : $coercedValue_value$$266$$;
      "disabled" != $key$$151$$ && this._super($key$$151$$, $coercedValue_value$$266$$, $flags$$39$$);
      "readOnly" === $key$$151$$ && (this.options.$readonly$ = $coercedValue_value$$266$$);
      "disabled" === $key$$151$$ && (this.options.disabled = $coercedValue_value$$266$$);
      switch($key$$151$$) {
        case "value":
          this.$_updateUI$();
          this.$_makeDraggable$();
      ...
      $oj$$45$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"value"}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$15$$, this, function($initializedOptions$$1$$) {
        for (var $toParse$$ = ["value", "step", "min", "max"], $i$$362$$ = 0;$i$$362$$ < $toParse$$.length;$i$$362$$++) {
          ...
          null != $value$$268$$ && ("step" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$162$$.$_parseStep$($value$$268$$) : "min" === $opt$$20$$ || "max" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$162$$.$_parse$($opt$$20$$, $value$$268$$) : "value" === $opt$$20$$ && (Array.isArray($value$$268$$) ? $initializedOptions$$1$$[$opt$$20$$] = $value$$268$$ : $initializedOptions$$1$$[$opt$$20$$] = $self$$162$$.$_parse$($opt$$20$$, $value$$268$$)));
        }
      });
    ...
    }, getSubIdByNode:function($node$$99$$) {
      if (null != $node$$99$$) {
        if ($node$$99$$.id === this.$_getThumbId$(0) && $$$$41$$($node$$99$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-0"};
        }
        if ($node$$99$$.id === this.$_getThumbId$(1) && $$$$41$$($node$$99$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-1"};
        }
        if ($$$$41$$($node$$99$$).hasClass("oj-slider-bar")) {
          return{subId:"oj-slider-bar"};
        }
        if ($$$$41$$($node$$99$$).hasClass("oj-slider-bar-value")) {
