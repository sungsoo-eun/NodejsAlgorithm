...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$34$$, $$$$31$$, $Hammer$$4$$) {
  (function() {
    $oj$$34$$.$__registerWidget$("oj.ojIndexer", $$$$31$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", version:"1.2", widgetEventPrefix:"oj", options:{data:null}, _ComponentCreate:function() {
    ...
    }, _setOption:function($key$$142$$, $value$$256$$) {
      ...
      var $prefixes$$, $i$$335$$, $j$$43$$, $node$$88$$, $includes$$;
      ...
      if ("oj-indexer-prefix" === $locator$$37_prefix$$18$$.subId) {
        for ($locator$$37_prefix$$18$$ = $locator$$37_prefix$$18$$.prefix, $prefixes$$ = this.element.children("li"), $i$$335$$ = 0;$i$$335$$ < $prefixes$$.length;$i$$335$$++) {
          $node$$88$$ = $prefixes$$.get($i$$335$$);
          if ($$$$31$$($node$$88$$).attr("data-range") == $locator$$37_prefix$$18$$) {
            return $node$$88$$;
          }
          $includes$$ = $$$$31$$($node$$88$$).attr("data-includes");
          if (null != $includes$$) {
      ...
      return null;
    }, getSubIdByNode:function($node$$89_prefix$$19$$) {
      return null != $node$$89_prefix$$19$$ && ($node$$89_prefix$$19$$ = $$$$31$$($node$$89_prefix$$19$$).attr("data-range"), null != $node$$89_prefix$$19$$) ? {subId:"oj-indexer-prefix", prefix:$node$$89_prefix$$19$$} : null;
      ...
      var $model$$64_prefixOthers$$, $root$$13$$, $last$$4_others_prefixes$$1$$, $availablePrefixes$$, $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$, $item$$113_prefix$$20$$;
      ...
      if (null != $model$$64_prefixOthers$$) {
        ...
        for ($first$$7_i$$336_itemHeight$$ = 1 + $height$$27_max$$7_skip$$2$$;$first$$7_i$$336_itemHeight$$ < $last$$4_others_prefixes$$1$$.length;$first$$7_i$$336_itemHeight$$ = $first$$7_i$$336_itemHeight$$ + $height$$27_max$$7_skip$$2$$ + 1) {
          1 < $height$$27_max$$7_skip$$2$$ ? ($item$$113_prefix$$20$$ = this.$_createSeparator$($last$$4_others_prefixes$$1$$, $first$$7_i$$336_itemHeight$$ - $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$ - 1), $root$$13$$.append($item$$113_prefix$$20$$)) : $first$$7_i$$336_itemHeight$$--, $item$$113_prefix$$20$$ = $last$$4_others_prefixes$$1$$[$first$$7_i$$336_itemHeight$$], $item$$113_prefix$$20$$ = this.$_createItem$($item$$113_prefix$$20$$, $availablePrefixes$$), $root$$13$$.append($item$$113_prefix$$20$$)
          ;
        }
      ...
      for ($item$$115$$.addClass("oj-indexer-ellipsis").attr("data-range", $indexString$$[$from$$3_i$$337$$ + Math.round(($to$$3$$ - $from$$3_i$$337$$) / 2)]);$from$$3_i$$337$$ < $to$$3$$;$from$$3_i$$337$$++) {
      ...
      var $self$$152$$ = this, $model$$65$$;
      this.element.uniqueId().addClass("oj-component-initnode").attr("tabIndex", 0);
      this._on(this.element, {click:function($event$$405$$) {
        $self$$152$$.$_handleClick$($event$$405$$);
      }, keydown:function($event$$406$$) {
        $self$$152$$.$_handleKeyDown$($event$$406$$);
      }, focus:function($event$$407$$) {
        $self$$152$$.$_handleFocus$($event$$407$$);
      }, blur:function($event$$408$$) {
        $self$$152$$.$_handleBlur$($event$$408$$);
      }});
    ...
    }, $_handleClick$:function($event$$409_target$$90$$) {
      0 === $event$$409_target$$90$$.button && ($event$$409_target$$90$$ = $$$$31$$($event$$409_target$$90$$.target), this.$_setCurrent$($event$$409_target$$90$$));
    ...
    }, $_handleKeyDown$:function($event$$412$$) {
      var $next$$7$$, $processed$$7$$ = !1;
      switch($event$$412$$.keyCode) {
        case 38:
      ...
      $processed$$7$$ && $event$$412$$.preventDefault();
      ...
      var $children$$10$$, $i$$338$$, $item$$120$$, $value$$257$$, $includes$$3$$;
      $children$$10$$ = this.element.children();
      for ($i$$338$$ = 0;$i$$338$$ < $children$$10$$.length;$i$$338$$++) {
        if ($item$$120$$ = $children$$10$$.get($i$$338$$), $value$$257$$ = $$$$31$$($item$$120$$).attr("data-range"), $includes$$3$$ = $$$$31$$($item$$120$$).attr("data-includes"), null != $value$$257$$ && $value$$257$$ == $prefix$$24$$ || null != $includes$$3$$ && -1 < $includes$$3$$.indexOf($prefix$$24$$)) {
          return $$$$31$$($item$$120$$);
        }
      }
      return null;
      ...
      $$$$31$$($element$$127$$).$ojHammer$($options$$306$$).on("panstart", function($event$$413$$) {
        $target$$91$$ = $event$$413$$.gesture.target;
        ...
        $currentY$$ = $y$$38$$;
      }).on("panmove", function($event$$414$$) {
        $previousY$$ = $currentY$$;
        $currentY$$ = $y$$38$$ + $event$$414$$.gesture.deltaY;
  ...
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_setOtherPrefix$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_setOtherPrefix$$() {
    var $prefixes$$4$$, $self$$155$$ = this, $match$$22$$, $groupItems$$6$$, $content$$34$$, $i$$340$$, $prefix$$28$$;
    ...
    return new Promise(function($resolve$$37$$) {
      ...
      $match$$22$$ ? ($self$$155$$.$listview$.$_scrollToGroupHeader$($match$$22$$), $resolve$$37$$($oj$$34$$.$IndexerModel$.PREFIX_OTHERS)) : $resolve$$37$$(null);
    });
  };
