...
function(a,b){s=b.distance;null!=r&&s>k&&(n=f.Event("ojdefaultaction"),c.trigger(n,g),a.preventDefault());s<l&&(200<(new Date).getTime()-p||10>s)&&a.preventDefault()}))};o_("SwipeToRevealUtils.setupSwipeActions",b.tv.$pa,b);b.tv.nqa=function(a){var d;d=f(a);a={};a.selector=d;d=b.o.lt(d);null!=d&&d.off("click.swipetoreveal");b.o.B5(a)};o_("SwipeToRevealUtils.tearDownSwipeActions",b.tv.nqa,b)});
